...
constexpr eEndian kValue = eEndian::kLittle;
constexpr std::string_view kName = "kLittle";
#else
constexpr eEndian kValue = eEndian::kBig;
constexpr std::string_view kName = "kBig";
#endif
...
std::string_view name() noexcept
{
    ...
    if (value() == eEndian::kLittle)
    {
        return "kLittle"sv;
    }
    else if (value() == eEndian::kBig)
    {
        return "kBig"sv;
    }
    else
...
{
    static_assert((kValue == eEndian::kLittle) || (kValue == eEndian::kBig),
                  "Sorry but such endian is unsuppurted.");
    if constexpr (kValue == eEndian::kLittle)
    {
